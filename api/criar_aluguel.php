...
$idCliente = $conn->query("SELECT id_cliente FROM clientes WHERE nome_cliente = $nomeCliente");
$idLivro = $conn->query("SELECT id_livro FROM livros WHERE nome_livro = $nomeLivro");
